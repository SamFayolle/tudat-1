                                  ...
                                  const bool propagateNominal = true )
{
    ...
    Eigen::Matrix< StateScalarType, Eigen::Dynamic, 1 > initialState = 
        getZeroProperModeRotationalState< TimeType, StateScalarType >( bodies,
                 propagatorSettings, bodyMeanRotationRate, dissipationTimes, propagatedStates,
                 dependentVariables, propagateNominal, false );
        ...
        const bool propagateNominal = true )
{
    ...
    Eigen::Matrix< StateScalarType, Eigen::Dynamic, 1 > initialState = 
        getZeroProperModeRotationalState< TimeType, StateScalarType >( bodies, propagatorSettings,
                bodyMeanRotationRate, dissipationTimes, propagatedStates, dependentVariables, propagateNominal, false );
